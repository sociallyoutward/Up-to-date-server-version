...
var centerY;
var index;
var bubbleColors = new Array("red", "tomato", "orange", "yellow", "green", "springGreen", "blue","turquoise", "purple");
//new Array("#808080","#e9afaf","#aade87","#afdde9","#e5d5ff","#c8b7be","#ffccaa","#afe9c6","#afc6e9","#eeaaff","#917c6f","#ffeeaa","#d7f4d7","#afafe9","#e9afc6","#ffb571","#eeffaa","#d5fff6","#d5d5ff","#ffd5f6","#ffff7b");
