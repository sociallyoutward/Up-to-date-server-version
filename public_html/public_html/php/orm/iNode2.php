...
class iNode
{
	...
	private $hostname = "socia150sodb.db.10383250.hostedresource.com";
    private $username = "socia150sodb";
    private $dbname = "socia150sodb";

	public static function create($name, $parent) {
		$mysqli = new mysqli($hostname, $username, "jizzleMan@1", $dbname);
