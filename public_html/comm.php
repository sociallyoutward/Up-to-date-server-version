                        ...
                        <ul id="menu" class="menu">
                            ...
                            <li><a href="#"><button type="button" class="btn btn-default btn-block">Arts, Crafts, & Hobbies</button></a>
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="#"><button type="button" class="btn btn-warning btn-block">Automobiles</button></a>
                                        <ul class="sub-menu">
                                            <li><button type="button" class="btn btn-primary btn-block">Motorcycles</button></li>
